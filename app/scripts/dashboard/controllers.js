(function (define) {
    ...
    define(["dashboard/init"], function (dashboardModule) {
        ...
        dashboardModule
            ...
            .controller("pageSidebarController", ["$scope", "$pageSidebarService", function ($scope, $pageSidebarService) {
                $scope.it = $pageSidebarService;
                $scope.items = $pageSidebarService.getItems();
            }])
